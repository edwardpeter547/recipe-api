...
def recipe_detail_url(recipe_id):
    """Return the url for recipe detail given the id."""
...
def sample_recipe(user, **params):
    ...
    defaults = {"title": "simple recipe", "time_minutes": 10, "price": 5.00}
...
class PrivateRecipeApiTests(TestCase):
    ...
    #         email="temp@retepsystemsltd.com", password="tempPassword"
    #     )
    ...
    #         "price": 10.00,
    #     }
    #     self.client.put(recipe_detail_url(recipe.id), payload)
